...
// Canonical shadcn/ui DropdownMenu (radix). The menu primitive for the
// composer's Agent ▾ / Model ▾ pickers and any overflow/switcher menu — keyboard
// nav, roving focus, and `role="menu"` semantics come for free, so we never
// hand-roll a menu. Overlay surface = `bg-popover` (the fourth elevation tier);
// radix enter/exit animations need `tw-animate-css` (already imported globally).
