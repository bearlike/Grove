...
//
// Grove override of the upstream theme file: the tool is named/branded "grove"
// rather than the theme's default so no vendor name leaks into the page.
if (typeof navigator !== "undefined" && navigator.modelContext) {
  const controller = new AbortController();

  navigator.modelContext.registerTool(
    {
      name: "search_grove_docs",
      description:
        "Full-text search across Grove documentation. Returns matching page titles, URLs, and excerpts.",
      inputSchema: {
        type: "object",
        properties: {
